...
if __name__ == '__main__':
    ...
    select_list_dir_2_plot = {
        ...
        'ANT_MLJ':{    
            'npairs'  : 3, # provide number of pairs
             'Coupling' : [29.7, 6.8, 6.8], #meV ---- provide list of couplings for all pairs
             'msd_length' : [6.04, 5.24, 5.24 ],  # distances Angstrom for each pair of molecules considered, not necessary is PBC is used 
             ...
             'free_energy_bias' : [0.0, 0.0, 0.0 ], #meV ----provide list for all pairs  
             'frequency' : [1601,1601, 1601 ],  # frequency cm-1 -----provide list for all pairs
            ...
            'Time step' : 0.1 , #fs
            'Read_connectivity' : False, # if true you mast supply connectivity file in which pbc are or are not included
             'Method rate calc' : 'MLJ_rate', #this can be Marcus = "NA", Jacob mod = "TOT", or MLJ_rate for quantized rate
        ...
        'ANT_Spec_Over':{    
            ...
            'Read_connectivity' : True, # if true you mast supply connectivity file in which pbc are or are not included
             'Method rate calc' : 'SO', #this can be Marcus = "NA", Jacob mod = "TOT", or "MLJ_rate" for quantized rate, "SO" for spectral overlap
            # if MLJ_rate is provided 
              "lambda_classical"  : [124.7, 124.7, 124.7 ], #meV
              "lambda_quantum"    : [436.0,436.0,436.0 ], # meV 
              'frequency_quantum' : [2.79e14, 2.79e14, 2.79e14],  # angualar freq in s-1
    ...
    #systems_list = [ 'ANT_MLJ', 'ANT_Marcus', 'ANT_Spec_Over']
    systems_list = [ 'ANT_Marcus' ]
